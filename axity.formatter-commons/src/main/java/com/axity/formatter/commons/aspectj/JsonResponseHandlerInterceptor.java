package com.axity.formatter.commons.aspectj;
...
import com.axity.formatter.commons.exception.ValidationException;
import com.axity.formatter.commons.response.GenericResponseDto;
import com.axity.formatter.commons.response.HeaderDto;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
   ...
   * 
   */
  @Around("execution (* com.axity.formatter.controller.*.*(..))"
      + " and @annotation(com.axity.formatter.commons.aspectj.JsonResponseInterceptor)")
